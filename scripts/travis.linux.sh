...
function do_script() {
  ...
  --url-ignore="/reference/cmsis-plus/,/pt/,https://jekyllrb.com,http://developer.apple.com/downloads/,https://developer.apple.com/downloads/,https://www.element14.com/community/.*" \
  "${site}"
