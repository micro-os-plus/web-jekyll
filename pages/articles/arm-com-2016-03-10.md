...
For now it may not be perfect (as it tries to be), but it definitely provides a more standard set of primitives, closer to POSIX, and a wider set of APIs, covering both C++ and C applications; at the same time it does its best to preserve compatibility with the original ARM CMSIS RTOS.

Any contributions to improve CMSIS++ will be highly appreciated.

## More info

The main source of information for CMSIS++ is the [project site](http://micro-os-plus.github.io/cmsis-plus/).
